...
INSERT INTO "new_pets" ("age", "breed", "color", "createdAt", "description", "gender", "healthStatus", "id", "images", "isNeutered", "isVaccinated", "location", "name", "ownerId", "personality", "shelterId", "size", "species", "status", "updatedAt") SELECT "age", "breed", "color", "createdAt", "description", "gender", "healthStatus", "id", "images", "isNeutered", "isVaccinated", "location", "name", "ownerId", "personality", "shelterId", "size", "species", "status", "updatedAt" FROM "pets";
DROP TABLE "pets";
